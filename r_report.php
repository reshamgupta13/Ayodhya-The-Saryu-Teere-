...
<?php
	if(isset($_POST['u_name'])){
		if(isset($_POST['edit']) && $_POST['edit'] != ''){
			...
			$sql = 'insert into registration_form (u_name,email,password,confirm_password) values("'.$_POST['u_name'].'","'.$_POST['email'].'","'.$_POST['password'].'","'.$_POST['confirm_password'].'")';
...
<body>
<button class="btn btn-danger m-0 p-0"><a href="registration.php">Go Back</a></button>
<h1 class="bg-secondary text-white text-center">Registration Report</h1>
								...
								<tr class="bg-primary text-white " align="center">
									...
									<?php
										...
										while($row = mysqli_fetch_assoc($result)){
											...
											<td><a href="r_report.php?edit='.$row['s_no'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color: #3066ec;"> Edit</h3></a></td>
											<td><a href="r_report.php?del='.$row['s_no'].'" onClick="return confirm(\'Are you sure? \');" <h3 style="color:red;"></h3>Delete</a></td>
												</tr>'	;
										}
									?>
							</table>
