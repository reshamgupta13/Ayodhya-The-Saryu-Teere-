...
<div class="row col-md-7">
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="feedback_php.php" class="btn " style="background-color:#DDC5BC; text-color:white; padding:10px;  font-family: 'Kaushan Script', cursive;">Feedback</a></li>
        </ul>
      </nav><!-- .navbar -->
      </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="mb-3">
          <div class="mapouter"><div class="gmap_canvas"><iframe width="987" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=Ayodhya&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://embedgooglemap.net/124/"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:987px;}</style><a href="https://www.embedgooglemap.net">embed google map</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:1072px;}</style></div></div>
        </div><!-- End Google Maps -->
        ...
        <form action="contact_php.php" method="POST" role="form" class="php-email-form p-3 p-md-4">
          <div class="row">
            <div class="col-xl-6 form-group">
              <input type="text" name="name" class="form-control" id="name" placeholder="Your Name" required value="<?php echo isset($_GET['edit'])?$res['name']:""?>">
            </div>
            <div class="col-xl-6 form-group">
              <input type="email" class="form-control" name="email" id="email" placeholder="Your Email" required value="<?php echo isset($_GET['edit'])?$res['email']:""?>">
            </div>
          </div>
          <div class="form-group">
            <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" required value="<?php echo isset($_GET['edit'])?$res['subject']:""?>">
          </div>
          <div class="form-group">
            <textarea class="form-control" name="message" rows="5" placeholder="Message" required value="<?php echo isset($_GET['edit'])?$res['message']:""?>"></textarea>
          </div>
          <div class="my-3">
